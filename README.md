...
- 🎯 Entry points to execute your program using `python -m <traces_analyzer>` or `$ traces_analyzer` with basic CLI argument parsing.
...
Awesome traces_analyzer created by TOD-theses

## Install it from PyPI

```bash
pip install traces_analyzer
```
